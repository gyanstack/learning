...
@Component({
  selector: 'app-business-banking-workflow-data',
  templateUrl: './business-banking-workflow-data.component.html',
  styleUrls: ['./business-banking-workflow-data.component.css'],
  providers: [
...
export class BusinessBankingWorkflowDataComponent implements AfterViewChecked {
  form: FormGroup;
  fileType = fileTransactionType.BUSINESS_BANKING_TRANSACTION;
